...
title: 'AUDIO',
body: 'Mixyla Bot',         
previewType: 0, thumbnail: await (await fetch(`https://telegra.ph/file/0be0e281c9592ef167076.jpg`)).buffer(),
...
let json = await res.json()
conn.sendFile(m.chat, json.result.url, 'error.mp4', `_Miracle`, m)}
}catch(e){
